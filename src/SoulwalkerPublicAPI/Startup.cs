...
public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddSwaggerGen(c => {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "Soulwalker Public API", Version = "v1" });
                ...
                var filePath = Path.Combine(System.AppContext.BaseDirectory, "SoulwalkerPublicAPI.xml");
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            app.UseSwaggerUI(c =>
            {
                c.SwaggerEndpoint("./v1/swagger.json", "Soulwalker Public API");
            });
